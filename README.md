# BlossomNav: A Low-Cost Hardware Setup and Software Suite for Mobile Socially Assistive Robots
...
The stable branch comes with images that you can run these three python scripts on. If you use these tutorial images, then you should get the following files added to your ```root``` BlossomNav folder:
```
├── <data>
