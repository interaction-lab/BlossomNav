...
The stable branch comes with images that you can run these three python scripts on. If you use these tutorial images, then you should get the following files added to your ```data``` directory:
```
